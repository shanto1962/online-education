<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <img src="https://cdn.vectorstock.com/i/500p/43/98/student-education-logo-vector-14724398.jpg" alt="Store Logo" class="brand-image img-circle elevation-3" style="opacity: .8;width: 2.5rem;height: 2.5rem;max-height: unset">
